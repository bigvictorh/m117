...
public class Brainstorm extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.brainstorm);
    ...
    private class MessagesAdapter extends ArrayAdapter<Message> {
        MessagesAdapter(ArrayList<Message> messages) {
            super(Brainstorm.this, R.layout.message, R.id.message, messages);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (message.getSender().equals("Victor")) {
...
//                }
                ...
                nameView.setBackgroundResource(R.drawable.cloud_blue);
            } else {
//                if (sdk >= Build.VERSION_CODES.JELLY_BEAN) {
...
//                }
                layoutParams.gravity = Gravity.CENTER;
                nameView.setTextColor(Color.BLACK);
                nameView.setBackgroundResource(R.drawable.cloud_green);
            }
